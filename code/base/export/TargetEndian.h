...
inline constexpr auto BYTESWAP16(T1 &&n)
    -> decltype((((n & 0xFF00) >> 8) | ((n & 0x00FF) << 8))) {
  return ((((n & 0xFF00) >> 8) | ((n & 0x00FF) << 8)));
}
// can be used for int or unsigned int or float (4-byte types)
template <typename T1>
inline constexpr auto BYTESWAP32(T1 &&n)
...
template <typename T1>
inline constexpr auto BYTESWAP64(T1 &&n)
...
template <typename T1>
inline constexpr auto hton16(T1 &&__x__) -> decltype(BYTESWAP16(__x__)) {
  return (BYTESWAP16(__x__));
}
template <typename T1>
inline constexpr auto hton32(T1 &&__x__) -> decltype(BYTESWAP32(__x__)) {
  return (BYTESWAP32(__x__));
}
template <typename T1>
inline constexpr auto hton64(T1 &&__x__) -> decltype(BYTESWAP64(__x__)) {
  return (BYTESWAP64(__x__));
}

template <typename T1>
inline constexpr auto ntoh16(T1 &&__x__) -> decltype(BYTESWAP16(__x__)) {
  return (BYTESWAP16(__x__));
}
template <typename T1>
inline constexpr auto ntoh32(T1 &&__x__) -> decltype(BYTESWAP32(__x__)) {
  return (BYTESWAP32(__x__));
}
template <typename T1>
inline constexpr auto ntoh64(T1 &&__x__) -> decltype(BYTESWAP64(__x__)) {
  return (BYTESWAP64(__x__));
}
#else
