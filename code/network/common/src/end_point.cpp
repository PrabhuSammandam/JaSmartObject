...
{
  return ( is_bit_set( _u16_network_flags, k_network_flag_multicast ) );
}

bool Endpoint::is_ipv4()
{
  return ( is_bit_set( _u16_network_flags, k_network_flag_ipv4 ) );
}
bool Endpoint::is_ipv6()
{
  return ( is_bit_set( _u16_network_flags, k_network_flag_ipv6 ) );
}
bool Endpoint::is_secure()
{
  return ( is_bit_set( _u16_network_flags, k_network_flag_secure ) );
}
