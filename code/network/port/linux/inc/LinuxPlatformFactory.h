...
#ifndef NETWORK_PORT_LINUX_INC_LINUXPLATFORMFACTORY_H_
#define NETWORK_PORT_LINUX_INC_LINUXPLATFORMFACTORY_H_
...
#endif /* NETWORK_PORT_LINUX_INC_LINUXPLATFORMFACTORY_H_ */
