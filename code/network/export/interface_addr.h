...
class InterfaceAddress
{
  public:
    ...
    IpAddrFamily get_family() const { return ( family_ ); }
    void         set_family( const IpAddrFamily family ) { family_ = family; }
    ...
    void         set_addr( IpAddrFamily family, const char *addr );
    char*        get_addr() { return ( &address_[0] ); }

    bool is_ipv4() { return ( family_ == IpAddrFamily::IPv4 ); }
    bool is_ipv6() { return ( family_ == IpAddrFamily::IPv6 ); }
