...
uint8_t CollectionResource::handle_request(Interaction *interaction)
{
...
uint8_t CollectionResource::get_representation(ResInterfaceType interface_type, ResRepresentation &representation)
{
	return (uint8_t());
}

uint8_t CollectionResource::get_discovery_representation(ResRepresentation &representation)
{
...
uint8_t CollectionResource::handle_get(Interaction *interaction)
{
...
uint8_t CollectionResource::handle_post(Interaction *interaction)
{
	return (uint8_t());
}

void CollectionResource::init()
{
	add_type("oic.wk.col");
	add_interface("oic.if.ll");
	add_interface("oic.if.baseline");
	add_interface("oic.if.b");
