...
{
  public:
    GetRequestInfo( ja_iot::network::Endpoint &endpoint, std::string uri_path, ja_iot::stack::client_response_cb response_cb );
...
{
  public:
    PutRequestInfo( ja_iot::network::Endpoint &endpoint, std::string uri_path, ja_iot::stack::client_response_cb response_cb );
