...
/*********************PutRequestInfo**********************************************/
/**********************************************************************************/
PutRequestInfo::PutRequestInfo( Endpoint &endpoint, std::string uri_path, client_response_cb response_cb ) :
  BaseRequestInfo{ endpoint, uri_path, response_cb }
{
}
...
uint8_t Client::put( PutRequestInfo &put_request_info )
{
  ...
  auto request = new ClientRequest {};
